const getProducts = () =>{
    axios.get('https://localhost:3000/produtos')
    .then(response => {
...
function deleteProduct(productId) {
    axios.delete(`https://localhost:3000/produtos/${productId}`)
        .then(response => {
...
function editProduct(productId, currentName, currentPrice) {
    ...
    if (newName !== null && newPrice !== null) {
        ...
        axios.put(`https://localhost:3000/produtos/${productId}`, updatedProduct)
            .then(response => {
...
function addProduct() {
    ...
    if (name && price) {
        ...
        axios.post('https://localhost:3000/produtos', newProduct)
            .then(response => {
